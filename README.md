...
[React front end]([https://github.com/Itswali/hello-rails-front-end.git](https://github.com/Itswali/hello-rails-front-end/tree/final))
...
```sh
  git https://github.com/Itswali/hello-rails-back-end.git
